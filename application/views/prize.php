    ...
    <section class="intro">
		...
		<div class="center-content">
			...
			<div class="intro-content text-center">	
				...
				<!-- ==== Main Heading ==== -->												
				<h1 class="intro-title">ผู้ได้รับรางวัลจากการ<span class="obak">เฝ้าเดี่ยว</span></h1>
				...
				<!-- ====+++ Countdown Timer +++==== -->						
				<ul class="countdown">
					<li><span><?php echo $people->name; ?> (<?php echo $people->email; ?>)</span>
					</li>
			        <!--li>
				...
				<div class="intro-subtitle">
					...
					<p>
						<?php $i = 1; foreach ($peoplewons as $peoplewon) {
							echo $i.".".$peoplewon->name."(".$peoplewon->mission.") ";
							$i++;
						}
						?>
					</p>
