    ...
    <section class="intro">
		...
		<div class="center-content">
			...
			<div class="intro-content text-center">	
				...
				<!-- ==== Main Heading ==== -->												
				<h1 class="intro-title">ระบบบันทึกการ<span class="obak">เฝ้าเดี่ยว</span></h1>
		...
		<div class="container-bottom-content">					
			...
			<div class="social">
				...
				<a href="<?php echo base_url(); ?>auth/index"><i class="fa fa-sign-in fa-2x fa-social"></i></a>
				<a href="<?php echo base_url(); ?>auth/logout"><i class="fa fa-sign-out fa-2x fa-social"></i></a>
			</div> <!-- /End Social Links -->

			<!-- ==== Notify Section ==== -->
			<div class="notify-after text-center">						
				<h2>สวัสดี <?php echo $this->session->userdata('username'); ?> mission <?php echo $this->session->userdata('groupname'); ?></h2>
	...
	<section class="content-wrapper">
		...
		<div class="about content-div">
			<div class="container padding-x">
				...
				<table class="table">
					<thead><tr><th>ID</th><th>ชื่อ-นามสกุล</th><th>Mission</th><th>วันที่</th><th>กำเนินการ</th></tr></thead>
					<tbody id="fillgrid">
...
$('.countdown').downCount({
    date: '<?php echo $week->week_end; ?>',
    offset: +7
}, function () {
    alert('Time\'s up, done!');
});
